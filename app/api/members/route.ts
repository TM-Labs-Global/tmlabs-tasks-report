        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="background:#0F1B35;color:#F0F4FF;font-family:sans-serif;padding:40px;max-width:600px;margin:0 auto;border-radius:12px;">
              ...
              <a href="${appUrl}/login" style="display:inline-block;background:linear-gradient(135deg,#FF3396,#6633FF);color:white;text-decoration:none;padding:12px 28px;border-radius:8px;font-weight:600;font-size:15px;">
                Log In to TM Labs
              </a>
